...
public class QuanBuShouWenFragment extends Fragment {
    ...
    private void initDemand() {
        ...
        demand.dictionaryNames = "category.workflow_template_category,departmentId.所有部门,companyId.公司,areasId.区域,agentId.base_staff";
        demand.src = Global.BASE_JAVA_URL + GlobalMethord.全部收文列表;
    }
...
//                viewHolder.setTextValue(R.id.tv_name_apply_list, item.getFormName()); //表单名称
    ...
    public void setSelectDate(String beginTime, String endTime) {
        Map<String,String> searchMap = new HashMap<>();
        searchMap.put("searchField_datetime_submissionTime",beginTime + "|" + endTime);
