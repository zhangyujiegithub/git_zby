...
import com.biaozhunyuan.tianyi.base.BaseFragment;
...
//                            String url = Global.BASE_JAVA_URL + GlobalMethord.表单详情 + "?workflowId=" + dynamic.getDataId();
...
//                            break;
//                        case "客户消息":
//                            intent.setClass(getActivity(), ClientRelatedInfoActivity.class);
//                            break;
//                        case "跟进记录消息":
