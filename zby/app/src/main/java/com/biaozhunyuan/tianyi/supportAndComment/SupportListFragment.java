...
public class SupportListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (commentPost != null) {
            getSupportList(commentPost);
        }
        return view;
    }

    public static SupportListFragment newInstance(SupportListPost post) {
     ...
     * @param post
     */
    public void getSupportList(SupportListPost post) {
    ...
    public void setOnSupportCountListener(SupportCountListener listener) {
