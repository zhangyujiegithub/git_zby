...
import com.biaozhunyuan.tianyi.utils.VoiceVolumeThread;
...
public class WaveView extends View {
    ...
    private int[] COLORS = {R.color.waveview_green, R.color.waveview_blue, R.color.waveview_pink};
    ...
    private VoiceVolumeThread thread;
    ...
    private void initThread() {
        thread.setOnVoiceVolumeListener(new VoiceVolumeThread.OnVoiceVolumeListener() {
            @Override //监听当前输出语音大小
