...
public class MediaManager {
    ...
    public static void playSound(Context context, String filePathString,
        ...
        playSound(context, filePathString, onCompletionListener, false);
    }


    public static void playSound(Context context, String filePathString,
                                 OnCompletionListener onCompletionListener, boolean isLoud) {//
        int soundMode = isLoud ? AudioManager.STREAM_MUSIC : AudioManager.STREAM_VOICE_CALL;
        if (mPlayer == null) {
            ...
            int maxVolume = audioManager.getStreamMaxVolume(soundMode);
            audioManager.setStreamVolume(soundMode,
        ...
        try {
            ...
            mPlayer.setAudioStreamType(soundMode);
