...
public final class ToastUtils {
    ...
    public static void showToast(String message) {
        Toast toast = Toast.makeText(BoeryunApp.getInstance().getApplicationContext(), message, Toast.LENGTH_LONG);
        toast.setGravity(Gravity.CENTER, 0, 0);
        toast.show();
    }

    public static void showShort(String message) {
        Toast toast = Toast.makeText(BoeryunApp.getInstance().getApplicationContext(), null, Toast.LENGTH_SHORT);
