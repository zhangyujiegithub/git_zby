package com.biaozhunyuan.tianyi.helper.signaturepad;
...
import com.biaozhunyuan.tianyi.helper.signaturepad.utils.Bezier;
import com.biaozhunyuan.tianyi.helper.signaturepad.utils.ControlTimedPoints;
import com.biaozhunyuan.tianyi.helper.signaturepad.utils.SvgBuilder;
import com.biaozhunyuan.tianyi.helper.signaturepad.utils.TimedPoint;
...
public class SignaturePad extends View {
    ...
    public SignaturePad(Context context, AttributeSet attrs) {
        ...
        try {
            mMinWidth = a.getDimensionPixelSize(
                    R.styleable.SignaturePad_minWidth, convertDpToPx(8));
            mMaxWidth = a.getDimensionPixelSize(
                    R.styleable.SignaturePad_maxWidth, convertDpToPx(10));
            mVelocityFilterWeight = a.getFloat(
                    R.styleable.SignaturePad_velocityFilterWeight, 0.9f);
            mPaint.setColor(a.getColor(R.styleable.SignaturePad_penColor,
                    Color.BLACK));
        } finally {
            a.recycle();
        }
    ...
    public Bitmap getSignatureBitmap() {
        ...
        whiteBgBitmap.eraseColor(Color.argb(0,0,0,0));
    ...
    public Bitmap getTransparentSignatureBitmap(boolean trimBlankSpace) {
        ...
        return Bitmap.createBitmap(mSignatureBitmap, xMin, yMin, xMax - xMin,
                yMax - yMin);
    }
    ...
    private void addPoint(TimedPoint newPoint) {
        ...
        if (pointsCount > 3) {
            ...
            Bezier curve = mBezierCached.set(mPoints.get(1), c2, c3,
                    mPoints.get(2));
    ...
    private ControlTimedPoints calculateCurveControlPoints(TimedPoint s1,
        ...
        return mControlTimedPointsCached.set(getNewPoint(m1X + tx, m1Y + ty),
    ...
    private int convertDpToPx(float dp) {
        return Math
                .round(getContext().getResources().getDisplayMetrics().density
                        * dp);
    }
