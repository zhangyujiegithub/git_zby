package com.biaozhunyuan.tianyi.wheel;
...
import com.biaozhunyuan.tianyi.wheel.widget.adapters.ArrayWheelAdapter;
...
//                        tvTime.setText(getTime(date));
     ...
     * @param click
     */
    public static void alertBottomWheelOption(Context context, String[] list, final OnWheelViewClick click) {
        ...
        wv_option.setViewAdapter(new ArrayWheelAdapter(context,list));
