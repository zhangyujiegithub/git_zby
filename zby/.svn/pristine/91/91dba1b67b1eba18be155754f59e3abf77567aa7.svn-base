...
public class VoiceVolumeThread extends Thread {
    ...
    public void run() {
        ...
        while (isRun) {
            ...
            if (onVoiceVolumeListener != null) {
                onVoiceVolumeListener.onChange(v / (float) r * 2);
            }
    ...
    private OnVoiceVolumeListener onVoiceVolumeListener;

    public void setOnVoiceVolumeListener(OnVoiceVolumeListener onVoiceVolumeListener) {
        this.onVoiceVolumeListener = onVoiceVolumeListener;
    }
